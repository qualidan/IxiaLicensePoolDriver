...
class GenericPowerPort(object):
    ...
    def port_description(self):
        ...
        :rtype: str
        """
        return self.attributes['Ixia License Pool.GenericPowerPort.Port Description'] if 'Ixia License Pool.GenericPowerPort.Port Description' in self.attributes else None
    ...
    def port_description(self, value):
        ...
        :type value: str
        """
        self.attributes['Ixia License Pool.GenericPowerPort.Port Description'] = value
